# Course index (student)

Canonical paths for each published module. Stubs (e.g. `lab_dylib_injection/`) redirect here.
...
| **AI-assisted RE** (off-cycle; after Ch. 8) | [`ai-re/README.md`](ai-re/README.md) · [`ai-re/SETUP.md`](ai-re/SETUP.md) (SSH + install) · [`ai-re/STUDENT_QUICK_REFERENCE.md`](ai-re/STUDENT_QUICK_REFERENCE.md) |
...
- Earlier modules (tooling, intro RE) consolidated under `docs/course/`  
- Optional: merge `lab_guide.md` / `dylib.md` into structured lesson pages  
