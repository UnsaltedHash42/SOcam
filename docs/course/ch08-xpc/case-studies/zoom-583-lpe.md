...
**Repo (class narration):** [`05_zoom_exploit_lab.sh`](../../../../labs/ch08-xpc/05_zoom_exploit_lab.sh) + [`05_zoomxpc.m`](../../../../labs/ch08-xpc/05_zoomxpc.m) — requires Drive files named in the script header.
